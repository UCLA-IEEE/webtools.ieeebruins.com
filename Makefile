...
deploy-development:
	ssh $(BLUEHOST_USER)@$(BLUEHOST_HOST) "cd public_html/webtools-development; git pull"

deploy-production:
	ssh $(BLUEHOST_USER)@$(BLUEHOST_HOST) "cd public_html/webtools-production; git pull"
